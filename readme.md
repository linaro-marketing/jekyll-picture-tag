...
group :jekyll_plugins do
  gem 'jekyll-4-picture-tag', git: 'https://github.com/robwierzbowski/jekyll-4-picture-tag/'
end
```
...
Add `jekyll-4-picture-tag` to your Gemfile in the `:jekyll_plugins` group.
...
[Github issue tracker](https://github.com/robwierzbowski/jekyll-4-picture-tag/issues).
